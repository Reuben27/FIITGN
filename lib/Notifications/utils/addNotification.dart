...
Future <void> notiAdd(String tokenid, int hour, int minute, int workoutid) async {
  CollectionReference notify = FirebaseFirestore.instance.collection("Notifications");
