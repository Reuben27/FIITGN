...
class Plans_createdByUser extends StatefulWidget {
  ...
  @override
  _Plans_createdByUserState createState() => _Plans_createdByUserState();
}

class _Plans_createdByUserState extends State<Plans_createdByUser> {
  ...
  in_init() async {
    ...
    plansList = workoutDataProvider.plans_created_by_user();
    print(plansList);
    setState(() {
      isLoading = false;
    });
